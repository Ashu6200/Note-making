        ...
        <section className='w-full mt-4 pl-4'>
            <div className="w-full flex flex-col items-center justify-center tablet:items-start tablet:justify-start">
                <div className='p-4 grid items-center'>
                    <div className='flex flex-col items-center mt-6 gap-2 tablet:items-start tablet:justify-start'>
                    ...
                    <form className='flex flex-col gap-3 mt-4 max-w-[343px]' onSubmit={onSubmit}>
                        <div>
                            ...
                            {errors.email?.type === "required" && (
                                <p role="alert" className="font-normal text-xs text-red-500 ">Name is required</p>
                            )}
                        </div>
                        <Datepicker />
                        <div>
                    ...
                    <div className='min-w-[320px] px-2.5 pb-2.5 pt-2.5 text-base text-gray-900 bg-transparent rounded-lg border-2 border-gray-300 appearance-none text-center font-semibold flex items-center justify-center'>
                        Continue with Google <img src='/images/goole.png' alt='' />
                    </div>

                    <div className="mt-8">
                        <p className='text-[#969696] font-normal text-sm'>Already have an account?? <Link to={'/signin'} className="text-[#367AFF] text-sm underline font-semibold">Sign in
                        </Link> </p>
                    </div>
                </div>
            </div>
